...
show_banner(){
    ...
    local lines=(
        "${C1}   ╔══════════════════════════════════════════════════════════════════════════════╗${R}"
        "${C1}   ║${R}  ${C1}██████╗ ${C2}██████╗ ${C3}███████╗${C4}███████╗  ${C5}███████╗${C6}██╗   ██╗${C1}███████╗${C2}███╗   ██╗${R}  ${C1}║${R}"
        "${C2}   ║${R}  ${C1}██╔══██╗${C2}██╔══██╗${C3}██╔════╝${C4}╚══███╔╝  ${C5}██╔════╝${C6}██║   ██║${C1}██╔════╝${C2}████╗  ██║${R}  ${C2}║${R}"
        "${C2}   ║${R}  ${C2}██████╔╝${C3}██║  ██║${C3}█████╗  ${C5}  ███╔╝   ${C5}███████╗${C6}██║   ██║${C1}█████╗  ${C2}██╔██╗ ██║${R}  ${C2}║${R}"
        "${C3}   ║${R}  ${C2}██╔══██╗${C3}██║  ██║${C4}██╔══╝  ${C5} ███╔╝    ${C5}╚════██║${C6}██║   ██║${C1}██╔══╝  ${C2}██║╚██╗██║${R}  ${C3}║${R}"
        "${C4}   ║${R}  ${C3}██████╔╝${C4}██████╔╝${C4}██║     ${C6}███████╗  ${C5}███████║${C6}╚██████╔╝${C1}███████╗${C2}██║ ╚████║${R}  ${C4}║${R}"
        "${C5}   ║${R}  ${C4}╚═════╝ ${C5}╚═════╝ ${C5}╚═╝     ${C6}╚══════╝  ${C5}╚══════╝${C6} ╚═════╝ ${C1}╚══════╝${C2}╚═╝  ╚═══╝${R}  ${C5}║${R}"
        "${C5}   ╠══════════════════════════════════════════════════════════════════════════════╣${R}"
