...
show_banner(){
    ...
    # BDFZ-SUEN ASCII Art - 動畫效果: 逐行淡入顯示
    local lines=(
        "${C1}   ═══════════════════════════════════════════════════════════════════════════${R}"
        "${C1}   ${C1}██████╗ ${C2}██████╗ ${C3}███████╗${C4}███████╗ ${C5}███████╗${C6}██╗   ██╗${C1}███████╗${C2}███╗   ██╗${R}"
        "${C2}   ${C1}██╔══██╗${C2}██╔══██╗${C3}██╔════╝${C4}╚══███╔╝ ${C5}██╔════╝${C6}██║   ██║${C1}██╔════╝${C2}████╗  ██║${R}"
        "${C2}   ${C2}██████╔╝${C3}██║  ██║${C3}█████╗  ${C5}  ███╔╝  ${C5}███████╗${C6}██║   ██║${C1}█████╗  ${C2}██╔██╗ ██║${R}"
        "${C3}   ${C2}██╔══██╗${C3}██║  ██║${C4}██╔══╝  ${C5} ███╔╝   ${C5}╚════██║${C6}██║   ██║${C1}██╔══╝  ${C2}██║╚██╗██║${R}"
        "${C4}   ${C3}██████╔╝${C4}██████╔╝${C4}██║     ${C6}███████╗ ${C5}███████║${C6}╚██████╔╝${C1}███████╗${C2}██║ ╚████║${R}"
        "${C5}   ${C4}╚═════╝ ${C5}╚═════╝ ${C5}╚═╝     ${C6}╚══════╝ ${C5}╚══════╝${C6} ╚═════╝ ${C1}╚══════╝${C2}╚═╝  ╚═══╝${R}"
        "${C5}   ───────────────────────────────────────────────────────────────────────────${R}"
        "${C4}                  ${G}🚀 Sing-Box 四協議一鍵安裝腳本 v2.0 🚀${R}"
        "${C5}             ${C5}VLESS-Reality │ VMess-WS │ Hysteria2 │ TUIC V5${R}"
        "${C6}   ═══════════════════════════════════════════════════════════════════════════${R}"
    )
