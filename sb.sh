...
show_banner(){
    ...
    local N1="\033[38;5;51m"   # Neon Cyan
    local N2="\033[38;5;45m"   # Electric Blue
    local N3="\033[38;5;39m"   # Deep Cyan
    local N4="\033[38;5;201m"  # Neon Magenta
    local N5="\033[38;5;165m"  # Electric Purple
    local N6="\033[38;5;93m"   # Deep Purple
    local G="\033[38;5;46m"    # Matrix Green
    local W="\033[1;37m"       # Bright White
    local D="\033[38;5;238m"   # Dim Gray
    local R="\033[0m"
    
    clear
    
    # BDFZ-SUEN Cyberpunk ASCII Art - Matrix/Glitch Style
    local lines=(
        ""
        "${D}   ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓${R}"
        "${N1}   ██████╗ ${N2}██████╗ ${N3}███████╗${N4}███████╗   ${N5}███████╗${N6}██╗   ██╗${N1}███████╗${N2}███╗   ██╗${R}"
        "${N2}   ██╔══██╗${N3}██╔══██╗${N4}██╔════╝${N5}╚══███╔╝   ${N6}██╔════╝${N1}██║   ██║${N2}██╔════╝${N3}████╗  ██║${R}"
        "${N3}   ██████╔╝${N4}██║  ██║${N5}█████╗  ${N6}  ███╔╝    ${N1}███████╗${N2}██║   ██║${N3}█████╗  ${N4}██╔██╗ ██║${R}"
        "${N4}   ██╔══██╗${N5}██║  ██║${N6}██╔══╝  ${N1} ███╔╝     ${N2}╚════██║${N3}██║   ██║${N4}██╔══╝  ${N5}██║╚██╗██║${R}"
        "${N5}   ██████╔╝${N6}██████╔╝${N1}██║     ${N2}███████╗   ${N3}███████║${N4}╚██████╔╝${N5}███████╗${N6}██║ ╚████║${R}"
        "${N6}   ╚═════╝ ${N1}╚═════╝ ${N2}╚═╝     ${N3}╚══════╝   ${N4}╚══════╝${N5} ╚═════╝ ${N6}╚══════╝${N1}╚═╝  ╚═══╝${R}"
        "${D}   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░${R}"
        "${G}         ╔══════════════════════════════════════════════════════════╗${R}"
        "${G}         ║${W}  � SING-BOX MULTI-PROTOCOL INSTALLER ${N4}v2.0${G}  ║${R}"
        "${G}         ╠══════════════════════════════════════════════════════════╣${R}"
        "${G}         ║${N1} ▸ VLESS-Reality ${D}│${N2} VMess-WS ${D}│${N4} Hysteria2 ${D}│${N5} TUIC V5 ${G}║${R}"
        "${G}         ╚══════════════════════════════════════════════════════════╝${R}"
        ""
    )

    # 逐行動畫顯示 - Matrix Rain Effect
    for line in "${lines[@]}"; do
        echo -e "$line"
        sleep 0.03  # 30ms 快速掃描效果
    done
}
