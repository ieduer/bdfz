...
# ==================== 漸層動畫 Banner ====================
show_banner(){
    # Subtle Geek Color Palette - understated but refined
    local C1="\033[38;5;75m"   # Soft Blue
    local C2="\033[38;5;111m"  # Light Steel Blue
    local C3="\033[38;5;147m"  # Light Purple
    local C4="\033[38;5;183m"  # Lavender
    local G="\033[38;5;114m"   # Muted Green
    local D="\033[38;5;240m"   # Dim Gray
    local W="\033[1;37m"       # Bright White
    local R="\033[0m"
    
    clear
    
    # BDFZ-SUEN - Clean minimalist geek style
    local lines=(
        ""
        "${D}    ┌──────────────────────────────────────────────────────────────────────┐${R}"
        "${D}    │${C1}  ██████╗ ${C2}██████╗ ${C3}███████╗${C4}███████╗  ${C1}███████╗${C2}██╗   ██╗${C3}███████╗${C4}███╗   ██╗ ${D}│${R}"
        "${D}    │${C1}  ██╔══██╗${C2}██╔══██╗${C3}██╔════╝${C4}╚══███╔╝  ${C1}██╔════╝${C2}██║   ██║${C3}██╔════╝${C4}████╗  ██║ ${D}│${R}"
        "${D}    │${C2}  ██████╔╝${C3}██║  ██║${C3}█████╗  ${C4}  ███╔╝   ${C1}███████╗${C2}██║   ██║${C3}█████╗  ${C4}██╔██╗ ██║ ${D}│${R}"
        "${D}    │${C2}  ██╔══██╗${C3}██║  ██║${C4}██╔══╝  ${C4} ███╔╝    ${C1}╚════██║${C2}██║   ██║${C3}██╔══╝  ${C4}██║╚██╗██║ ${D}│${R}"
        "${D}    │${C3}  ██████╔╝${C4}██████╔╝${C4}██║     ${C3}███████╗  ${C1}███████║${C2}╚██████╔╝${C3}███████╗${C4}██║ ╚████║ ${D}│${R}"
        "${D}    │${C3}  ╚═════╝ ${C4}╚═════╝ ${C4}╚═╝     ${C3}╚══════╝  ${C1}╚══════╝${C2} ╚═════╝ ${C3}╚══════╝${C4}╚═╝  ╚═══╝ ${D}│${R}"
        "${D}    ├──────────────────────────────────────────────────────────────────────┤${R}"
        "${D}    │${W}           Sing-Box Multi-Protocol Installer ${G}v2.0${W}                   ${D}│${R}"
        "${D}    │${D}      VLESS-Reality · VMess-WS · Hysteria2 · TUIC V5               ${D}│${R}"
        "${D}    └──────────────────────────────────────────────────────────────────────┘${R}"
        ""
    )
